    ...
    public List<RangerOpenmetadataEntityWithTags> getOpenmetadataTableEntities(OpenMetadata openMetadataGateway){
		...
		do{
			...
			for(Table tableEntity: TableList){
                ...
                // adds all the tags associated with the table entity to an array list
                ...
                // check if the current table entity object has columns. 
                if (!tableEntity.getColumns().isEmpty()){
                    ...
                    for (Column columnEntity: tableEntity.getColumns()){
                        ...
                        // adds all the tags associated with the column object to an array list
                        ...
                        entityWithTags = new RangerOpenmetadataEntityWithTags(entity, allTagsForColumnEntity);
                        // add the above entity with tags payload def to an array list
                        ret.add(entityWithTags);
                    }
                } 
