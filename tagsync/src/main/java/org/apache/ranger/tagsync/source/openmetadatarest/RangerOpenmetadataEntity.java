...
public class RangerOpenmetadataEntity {
    ...
    private final Table tableEntityObject;
    private final Column columnEntityObject;
    ...
    public Table getTableEntityObject(){
        return tableEntityObject;
    } 
     
    public Column getColumnEntityObject(){
